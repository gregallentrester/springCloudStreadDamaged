...
public class EmployeeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeKey\",\"namespace\":\"net.greg.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"departmentName\",\"type\":\"string\"}]}");
   ...
   */
  public static net.greg.schema.EmployeeKey.Builder newBuilder() {
    return new net.greg.schema.EmployeeKey.Builder();
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static net.greg.schema.EmployeeKey.Builder newBuilder(net.greg.schema.EmployeeKey.Builder other) {
    return new net.greg.schema.EmployeeKey.Builder(other);
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static net.greg.schema.EmployeeKey.Builder newBuilder(net.greg.schema.EmployeeKey other) {
    return new net.greg.schema.EmployeeKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.greg.schema.EmployeeKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.greg.schema.EmployeeKey other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.greg.schema.EmployeeKey.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.greg.schema.EmployeeKey.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.greg.schema.EmployeeKey.Builder setDepartmentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.greg.schema.EmployeeKey.Builder clearDepartmentName() {
      departmentName = null;
